module staking::pool {
    ...
    struct StakingMeta<phantom A> has key, store {
        ...
        reward_interval: StakingTimeInterval
    }
    ...
    public fun stake_tlp<A, B>(
        ...
        let interval = StakingTimeInterval{
            id: object::new(ctx),
            interval: epoch_time_lock::new(reward_interval, ctx)
        };
    ...
    public entry fun stake_tlp_<A, B> (
        ...
        stake_tlp(staking_pool, stake_tlp, reward_interval, owner, locked_until_epoch, ctx)
    }
}